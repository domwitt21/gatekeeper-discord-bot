...
class DashboardServer {
    ...
    async guildPageV2(request) {
        ...
        const notice = request.query.saved ? '<div class="notice">Settings saved and the verification message was republished.</div>' : request.query.policySaved ? '<div class="notice">Trust policy saved.</div>' : request.query.moderated ? '<div class="notice">Moderation action completed.</div>' : request.query.reverificationUpdated ? '<div class="notice">Reverification queue updated.</div>' : "";
        ...
        <nav class="section-nav" aria-label="Dashboard sections"><a href="#overview">Overview</a><a href="#configuration">Configuration</a><a href="#reverification">Reverification</a><a href="#reports">Reports</a><a href="#policies">Trust policies</a><a href="#moderation">Moderation</a><a href="#message">Message</a><a href="#activity">Activity</a></nav>
