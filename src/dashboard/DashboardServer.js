...
class DashboardServer {
    ...
    async guildPageV2(request) {
        ...
        return `${notice}
        <section class="guild-heading"><div><a href="/">← Servers</a><p class="eyebrow">Gatekeeper</p><h1>Verification overview</h1></div><span class="live"><i></i> Bot online</span></section>
