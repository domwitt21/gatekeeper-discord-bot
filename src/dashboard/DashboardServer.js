...
class DashboardServer {
    ...
    async overview(guildId, filters = {}) {
        const [successes, failures, recent, settings, daily, failureReasons, securityEvents, trustPolicies] = await Promise.all([
    ...
    async guildPageV2(request) {
        ...
        const notice = request.query.saved ? '<div class="notice">Settings saved and the verification message was republished.</div>' : request.query.policySaved ? '<div class="notice">Trust policy saved.</div>' : "";
        ...
        <nav class="section-nav" aria-label="Dashboard sections"><a href="#overview">Overview</a><a href="#configuration">Configuration</a><a href="#policies">Trust policies</a><a href="#message">Message</a><a href="#activity">Activity</a></nav>
